            ...
            <section id="theGallery">
                <div class="container">
                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="height:300px;">
                        ...
                        <!-- Controls -->
                        <a class="left carousel-control control-slide" href="#carousel-example-generic" data-slide="prev">
                        <span class="glyphicon glyphicon-chevron-left"></span>
                        </a>
                        <a class="right carousel-control control-slide" href="#carousel-example-generic" data-slide="next">
